...
class BerjalanStatusTiketAdapter :
    RecyclerView.Adapter<BerjalanStatusTiketAdapter.UserViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): BerjalanStatusTiketAdapter.UserViewHolder {
    ...
    override fun onBindViewHolder(
        holder: BerjalanStatusTiketAdapter.UserViewHolder,
        position: Int
    ) {
