...
class PunchlistFilterAdapter : RecyclerView.Adapter<PunchlistFilterAdapter.UserViewHolder>() {
...
//    }
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): PunchlistFilterAdapter.UserViewHolder {
    ...
    override fun onBindViewHolder(holder: PunchlistFilterAdapter.UserViewHolder, position: Int) {
