...
class TittleChecklistPerangkatAdapter :
    RecyclerView.Adapter<TittleChecklistPerangkatAdapter.UserViewHolder>() {
...
//    }
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): TittleChecklistPerangkatAdapter.UserViewHolder {
        val mView = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_tittle_checklist_perangkat, parent, false)
    ...
    override fun onBindViewHolder(
        holder: TittleChecklistPerangkatAdapter.UserViewHolder,
        position: Int
    ) {
