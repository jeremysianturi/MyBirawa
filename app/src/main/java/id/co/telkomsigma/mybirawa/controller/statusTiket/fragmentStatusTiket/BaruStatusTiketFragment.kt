...
import id.co.telkomsigma.mybirawa.viewmodel.statusTiketViewModel.BaruStatusTiketViewModel
import kotlinx.android.synthetic.main.semua_status_tiket_fragment.*

class BaruStatusTiketFragment : Fragment() {

    companion object {
        fun newInstance() = BaruStatusTiketFragment()
    ...
    private lateinit var viewModel: BaruStatusTiketViewModel

    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.baru_status_tiket_fragment, container, false)
    }
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel = ViewModelProvider(this, ViewModelProvider.NewInstanceFactory()).get(
            BaruStatusTiketViewModel::class.java
        )
        ...
        if (bundle != null) {
            ...
            Log.d(tag, "idFromBerandaBARU : $idBidangRequest")
...
//                    Log.d(tag,"statusBaruiket : ${model[0].statusResponse}")
                    showLoading(false)
                    showAdapter(true)
                    adapter.setData(model)
                } else {
