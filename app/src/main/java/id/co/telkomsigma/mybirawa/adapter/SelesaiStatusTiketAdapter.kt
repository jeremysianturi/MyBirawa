...
class SelesaiStatusTiketAdapter : RecyclerView.Adapter<SelesaiStatusTiketAdapter.UserViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): SelesaiStatusTiketAdapter.UserViewHolder {
    ...
    override fun onBindViewHolder(holder: SelesaiStatusTiketAdapter.UserViewHolder, position: Int) {
