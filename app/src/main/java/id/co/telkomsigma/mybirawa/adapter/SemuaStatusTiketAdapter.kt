...
class SemuaStatusTiketAdapter : RecyclerView.Adapter<SemuaStatusTiketAdapter.UserViewHolder>() {
    ...
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): SemuaStatusTiketAdapter.UserViewHolder {
    ...
    override fun onBindViewHolder(holder: SemuaStatusTiketAdapter.UserViewHolder, position: Int) {
